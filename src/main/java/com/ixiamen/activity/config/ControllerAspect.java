...
import com.ixiamen.activity.annotation.AccessLimit;
import com.ixiamen.activity.annotation.Log;
import com.ixiamen.activity.annotation.ParamXssPass;
import com.ixiamen.activity.annotation.ValidationParam;
import com.ixiamen.activity.aspect.*;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(* com.ixiamen.activity.controller..*(..))  ")
    public void aspect() {
    }
