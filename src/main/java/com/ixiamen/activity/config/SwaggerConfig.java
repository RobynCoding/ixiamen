...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        aParameterBuilder
                ...
                .name("Authorization")
                .description("header中Authorization字段用于认证，值为登录时获取的token")
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("v1").select()
                .apis(RequestHandlerSelectors.basePackage("com.ixiamen.activity.controller"))
